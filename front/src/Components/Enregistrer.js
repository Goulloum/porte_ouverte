...
function Enregistrer() {
    ...
    const handleQuery = (e) => {
        axios({
            method: "post",
            url: process.env.REACT_APP_API_URL + "query.php",
            data: {
                type: "add_user",
    ...
    return (
        <div className="enregistrer-container">
                ...
                <form autocomplete="off" onSubmit={(e) => validInput(e)} className="Container_Formulaire">
                    ...
                    <div className="Milieu_Formulaire">
                        <div className="PartM1">
                            <div className="Box_Informations">
                                ...
                                <div style={{ display: error.empty.includes("Nom") ? "inherit" : "none" }} className="error-email">
                            ...
                            <div className="Box_Informations">
                                ...
                                <div style={{ display: error.empty.includes("Prenom") ? "inherit" : "none" }} className="error-email">
                                    Veuillez renseigner ce champ
                                </div>
                            </div>
                            ...
                            <div className="Box_Informations">
                                ...
                                <div style={{ display: error.mail ? "inherit" : "none" }} className="error-email">
                                    Email non-conforme
                                </div>
                            </div>
                            ...
                            <div className="Box_Informations">
                                ...
                                <div style={{ display: error.tel ? "inherit" : "none" }} className="error-email">
                            ...
                            <div className="Box_Informations">
                                ...
                                <div style={{ display: error.empty.includes("Adresse") ? "inherit" : "none" }} className="error-email">
                                    Veuillez renseigner ce champ
                                </div>
                            </div>
                            ...
                            <div className="Box_Informations">
                                ...
                                <div style={{ display: error.empty.includes("Ville") ? "inherit" : "none" }} className="error-email">
                                    Veuillez renseigner ce champ
                                </div>
                            </div>
                            ...
                            <div className="Box_Informations">
                                ...
                                <div style={{ display: error.empty.includes("CP") ? "inherit" : "none" }} className="error-email">
                                    Veuillez renseigner ce champ
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="Fin_Formulaire">
                        <div className="Box_Newsletter">
                            ...
                            <label>
                                J'autorise l'ISCIO à utiliser mes informations afin de communiquer avec moi au sujet des inscriptions, <br /> des
                                formations qu'ils proposent et de diverses thématiques autour de l'apprentissage.
                            </label>
                        </div>
            ...
            <div style={{ display: statut ? "inherit" : "none" }} className="response-add-user-true">
                Vos informations ont bien été enregistrée,
                <br /> merci de votre participation
            </div>
            <div style={{ display: statut === false ? "inherit" : "none" }} className="response-add-user-false">
